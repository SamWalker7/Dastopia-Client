        ...
        <>
            {
                selected ? (
                    <div style={styles.container}>
                            ...
                            <div style={{ width: "100%" }}>
                                ...
                                <div style={{ display: "flex", gap: "6px" }}>
                                    <div style={{ display: "flex", gap: "2px", alignItems: "center" }}>
                                        <DoorOpen />
                                        <p style={{ fontSize: "13px", fontWeight: "bold" }}>{selected.doors} doors</p>
                                    </div>
                                    <div style={{ display: "flex", gap: "2px", alignItems: "center" }}>
                                        <PaintBucket />
                                        <p style={{ fontSize: "13px", fontWeight: "bold" }}>{selected.color} color</p>
                                    </div>
                                    <div style={{ display: "flex", gap: "2px", alignItems: "center" }}>
                                        <Armchair />
                                        <p style={{ fontSize: "13px", fontWeight: "bold" }}>{selected.seats} Seats</p>
                                    </div>
                                </div>
                        ...
                        <div style={{ display: "flex", justifyContent: "flex-start", alignItems: "flex_start", width: "100%", maxWidth: "1000px" }}>
                            <div style={{ width: "100%", paddingLeft: windowWidth < 1000 ? "10px" : "0px" }}>
                ...
                ) : <div style={{ paddingTop: "200px" }}> <p style={{ fontSize: "20px" }}> loading ... </p></div>
            }
        </>
    )
}
...
function Item(props) {
    ...
    return (
        <Paper style={{ boxShadow: "none" }}>
            <div style={{ height: "auto", width: windowWidth > 1020 ? "50vw": "100%", position: "relative" }}>
